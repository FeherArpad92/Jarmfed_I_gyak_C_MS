...
******************************************************************************/
 ...
 uint8_t timer_task10ms=0, timer_task100ms=0, timer_task500ms=0, timer_task1s=0;
...
* Description:      Timer jelzés lekérdezése
* Input:
...
int main(void)
{
	...
	while(1)
	{
		...
		{
			timer_cnt++;
			if((timer_cnt % 1) == 0) timer_task10ms =1;
			if((timer_cnt % 10) == 0) timer_task100ms =1;
			if((timer_cnt % 50) == 0) timer_task500ms =1;
			if((timer_cnt % 100) == 0) timer_task1s =1;
			//PORTA ^= (1<<PA0);
		}
